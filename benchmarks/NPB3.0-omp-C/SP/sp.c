  ...
  for (k = 1; k <= grid_points[2] - 2; k++) {
    ...
    for (j = 1; j <= grid_points[1] - 2; j++) {
      ...
      for (m = 0; m < 5; m++) {
        ...
        i = 2;
        forcing[m][i][j][k] =
            forcing[m][i][j][k] - dssp * (-4.0 * ue[m][i - 1] + 6.0 * ue[m][i] -
      ...
      for (m = 0; m < 5; m++) {
        i = grid_points[0] - 3;
        forcing[m][i][j][k] =
            forcing[m][i][j][k] - dssp * (ue[m][i - 2] - 4.0 * ue[m][i - 1] +
  ...
  for (k = 1; k <= grid_points[2] - 2; k++) {
    ...
    for (i = 1; i <= grid_points[0] - 2; i++) {
      ...
      for (m = 0; m < 5; m++) {
        ...
        j = 2;
        forcing[m][i][j][k] =
            forcing[m][i][j][k] - dssp * (-4.0 * ue[m][j - 1] + 6.0 * ue[m][j] -
      ...
      for (m = 0; m < 5; m++) {
        j = grid_points[1] - 3;
        forcing[m][i][j][k] =
            forcing[m][i][j][k] - dssp * (ue[m][j - 2] - 4.0 * ue[m][j - 1] +
  ...
  for (j = 1; j <= grid_points[1] - 2; j++) {
    ...
    for (i = 1; i <= grid_points[0] - 2; i++) {
      ...
      for (m = 0; m < 5; m++) {
        ...
        k = 2;
        forcing[m][i][j][k] =
            forcing[m][i][j][k] - dssp * (-4.0 * ue[m][k - 1] + 6.0 * ue[m][k] -
      ...
      for (m = 0; m < 5; m++) {
        k = grid_points[2] - 3;
        forcing[m][i][j][k] =
            forcing[m][i][j][k] - dssp * (ue[m][k - 2] - 4.0 * ue[m][k - 1] +
...
#pragma omp for
      for (j = 1; j <= grid_points[1] - 2; j++) {
        for (k = 1; k <= grid_points[2] - 2; k++) {
          rhs[m][i][j][k] = rhs[m][i][j][k] - dssp * (5.0 * u[m][i][j][k] -
                                                      4.0 * u[m][i + 1][j][k] +
                                                      u[m][i + 2][j][k]);
        }
      }
...
#pragma omp for
      for (j = 1; j <= grid_points[1] - 2; j++) {
        for (k = 1; k <= grid_points[2] - 2; k++) {
          rhs[m][i][j][k] = rhs[m][i][j][k] - dssp * (u[m][i - 2][j][k] -
                                                      4.0 * u[m][i - 1][j][k] +
                                                      5.0 * u[m][i][j][k]);
        }
      }
...
#pragma omp for
      for (i = 1; i <= grid_points[0] - 2; i++) {
        for (k = 1; k <= grid_points[2] - 2; k++) {
          rhs[m][i][j][k] = rhs[m][i][j][k] - dssp * (u[m][i][j - 2][k] -
                                                      4.0 * u[m][i][j - 1][k] +
                                                      5.0 * u[m][i][j][k]);
        }
      }
...
#pragma omp for
      for (i = 1; i <= grid_points[0] - 2; i++) {
        for (j = 1; j <= grid_points[1] - 2; j++) {
          rhs[m][i][j][k] = rhs[m][i][j][k] - dssp * (u[m][i][j][k - 2] -
                                                      4.0 * u[m][i][j][k - 1] +
                                                      5.0 * u[m][i][j][k]);
        }
      }
...
#pragma omp for
      for (i = 1; i <= grid_points[0] - 2; i++) {
        for (j = 1; j <= grid_points[1] - 2; j++) {
          ...
          overkill c               if this is the last cell)
          c-------------------------------------------------------------------*/
          fac2 = 1. / lhs[n + 2][i][j][k1];
          rhs[m][i][j][k1] = fac2 * rhs[m][i][j][k1];
        }
