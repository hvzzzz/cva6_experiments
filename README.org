...
# 1. CONFIGURATION
# ==========================================
REPORT_PATH = "./bitstreams/reports/utilization/SoC_wrapper_utilization_placed_2nd.rpt"
...
#+end_example
[[file:./.ob-jupyter/072d10f6f4faef62027b7fc81c8d056e0228c87c.png]]
:end:
...
# 1. CONFIGURATION
# ==========================================
TIMING_REPORT_PATH = "./bitstreams/reports/timing/SoC_wrapper_timing_summary_routed_2nd.rpt"
...
#+RESULTS:
:results:
#+begin_example✅ Reading timing report from: ./bitstreams/reports/timing/SoC_wrapper_timing_summary_routed_2nd.rpt
...
# 1. CONFIGURATION
# ==========================================
LOG_FILE_PATH = "./runs/UnixBench/unixbench_19700101_001958_2nd.txt"
FPGA_CLOCK_HZ = 50_000_000  # 50 MHz
...
#+end_example
[[file:./.ob-jupyter/fe1f54608913db97faeb9ea5b73ab5299a28a7f3.png]]
#+begin_example
...
# ==========================================
# Update this to your new log file name
LOG_FILE_PATH = "runs/NPB/NPB_19700101_000221_2nd.txt"
...
#+RESULTS:
:results:
#+begin_example✅ Loading data from: runs/NPB/NPB_19700101_000221_2nd.txt
#+end_example
[[file:./.ob-jupyter/89aacd822027c9a83e8eba09afb5a7335701c951.png]]
#+begin_example
