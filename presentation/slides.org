...
- \small How to measure it accurately.
...
#+attr_org: :width 500
#+name: fig:pynq
#+attr_latex: :width 11.0cm :options angle=0 :placement [!htb]
...
#+attr_org: :width 500
#+name: fig:pynq
#+attr_latex: :width 6.3cm :options angle=0 :placement [!htb]
...
#+attr_org: :width 500
#+name: fig:base_dsp
#+attr_latex: :width 7.0cm :options angle=0 :placement [!htb]
[[./figures/bench.png]]
...
#+attr_org: :width 500
#+name: fig:base_bram
#+attr_latex: :width 12.4cm :options angle=0 :placement [!htb]
...
#+attr_org: :width 500
#+name: fig:base_bram
#+attr_latex: :width 9.0cm :options angle=0 :placement [!htb]
