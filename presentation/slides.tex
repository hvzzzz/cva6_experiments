...
\section{Motivation}
\label{sec:org831fae7}
\begin{frame}[label={sec:orgf1cb720}]{The CVA6 Core}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgb05552c}]{The CVA6 Core}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org933efe9}]{The CVA6 Core}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org902d755}]{Problem Statement}
\begin{alertblock}{Problem}
\small The dual-core system is limited by a 1-request-per-cycle bandwidth at the L1D cache.
\end{alertblock}
\begin{exampleblock}{Research Objectives}\label{sec:orga6aeb9b}
\begin{itemize}
...
\end{exampleblock}
\end{frame}
\begin{frame}[label={sec:orgd54e04a}]{Project Roadmap}
\begin{center}
...
\label{sec:orgc89283a}
\begin{frame}[label={sec:orgb7d380b}]{How do We Measure Performance?}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org93c71c2}]{How do We Measure Performance and Resource Usage?}
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org036a103}]{How do We Measure Resource Usage?}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org05c256c}]{How do We Measure Resource Usage?}
\begin{center}
\includegraphics[trim=0 0 230 0, clip,width=\textwidth]{./figures/cva6_stages_annotated.pdf}
\label{fig:stages}
\end{center}
\end{frame}
\begin{frame}[label={sec:org5472027}]{How do We Measure Resource Usage?}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgb547a8c}]{How do We Measure Resource Usage?}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org8b0ecc5}]{How do We Measure Resource Usage?}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orge50d87d}]{How do We Measure Resource Usage?}
...
\end{frame}
\section{Experiments}
\label{sec:org76414c5}
\begin{frame}[label={sec:org85bdf4e}]{Baseline Architecture}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org9fac94d}]{Parameter Sweeps}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org4cd0a25}]{Automated Benchmarking Framework}
...
\label{sec:orgcad1f05}
\begin{frame}[label={sec:org4731ce8}]{Contributions}
\begin{itemize}
...
\label{sec:org1057370}
\begin{frame}[label={sec:orgebc2070}]{Conclusion}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org453e87c}]{Future Work}
\begin{center}
\includegraphics[trim=0 0 0 0, clip,width=\textwidth]{roadmap_future.pdf}
\label{fig:roadmap}
\end{center}
\end{frame}
\begin{frame}[label={sec:org5503c01}]{}
\frametitle{}
