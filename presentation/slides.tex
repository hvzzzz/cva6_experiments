...
\section{Motivation}
\label{sec:orgf1dfa66}
\begin{frame}[label={sec:org80de100}]{The CVA6 Core}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd1b8da3}]{The CVA6 Core}
\framesubtitle{Original Single Core Version}
\begin{center}
\includegraphics[angle=0,width=15cm]{./figures/cva6_block_diagram.png}
\label{fig:openhw}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgeb0caee}]{The CVA6 Core}
\framesubtitle{Benagil Team's Dual Core Version}
\begin{center}
\includegraphics[trim=0 0 50 0, clip,width=12cm]{./figures/multicore_cva6.pdf}
\label{fig:dualcore}
\end{center}
\end{frame}
\begin{frame}[label={sec:org06a1997}]{Problem Statement}
\begin{alertblock}{Problem}
\small The dual-core system is limited by a 1-request-per-cycle bandwidth at the L1D cache.
\end{alertblock}
\begin{exampleblock}{Research Objectives}\label{sec:orga2ffc72}
\begin{itemize}
...
\end{exampleblock}
\end{frame}
\begin{frame}[label={sec:orgf567b64}]{Project Roadmap}
\begin{center}
...
\label{sec:org225561b}
\begin{frame}[label={sec:orgd46e390}]{How do We Measure Performance?}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgb550912}]{How do We Measure Performance and Resource Usage?}
\framesubtitle{Experimental Setup}

\begin{figure}[!htb]
\centering
\includegraphics[angle=0,width=14.0cm]{./figures/pynq.jpeg}
\caption{\label{fig:pynq}CVA6 \emph{Single Core} deployment on a PYNQ-Z2 FPGA with PMod Modules}
\end{figure}
\end{frame}
\begin{frame}[label={sec:org730414d}]{How do We Measure Resource Usage?}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{figure}[!htb]
\centering
\includegraphics[angle=0,width=7.5cm]{./figures/PL_block.png}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge35ef3c}]{How do We Measure Resource Usage?}
\begin{center}
\includegraphics[trim=0 0 230 0, clip,width=\textwidth]{./figures/cva6_stages_annotated.pdf}
\label{fig:stages}
\end{center}
\end{frame}
\begin{frame}[label={sec:org466135a}]{How do We Measure Resource Usage?}
\framesubtitle{Initial LUT Usage Measurement}
\begin{center}
\includegraphics[angle=0,width=15.0cm]{./figures/soc_breakdown_bar_pie_h_final_LUT.png}
\label{fig:base_lut}
\end{center}
\end{frame}
\begin{frame}[label={sec:orge7bc5cb}]{How do We Measure Resource Usage?}
\framesubtitle{Initial FF Usage Measurement}
\begin{center}
\includegraphics[angle=0,width=15.0cm]{./figures/soc_breakdown_bar_pie_h_final_FF.png}
\label{fig:base_ff}
\end{center}
\end{frame}
\begin{frame}[label={sec:org4466727}]{How do We Measure Resource Usage?}
\framesubtitle{Initial BRAM Usage Measurement}
\begin{center}
\includegraphics[angle=0,width=15.0cm]{./figures/soc_breakdown_bar_pie_h_final_BRAM.png}
\label{fig:base_bram}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgd1bf0a3}]{How do We Measure Resource Usage?}
\framesubtitle{Initial DSP Usage Measurement}
\begin{center}
\includegraphics[angle=0,width=15.0cm]{./figures/soc_breakdown_bar_pie_h_final_DSP.png}
\label{fig:base_dsp}
\end{center}
\end{frame}
\section{Experiments}
\label{sec:org8999166}
\begin{frame}[label={sec:org79517b2}]{Baseline Architecture}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org5dde85b}]{Parameter Sweeps}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:orgf853286}]{Automated Benchmarking Framework}
...
\begin{center}
\includegraphics[angle=0,width=8.0cm]{./figures/bench.png}
\label{fig:base_dsp}
\end{center}
\end{frame}
\section{Results}
\label{sec:org5c6ba95}
\begin{frame}[label={sec:org486184d}]{Performance Dynamics}
\begin{center}
\includegraphics[angle=0,width=15cm]{./figures/cache_size_unixbench.png}
\label{fig:base_bram}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgb376f6f}]{Performance Dynamics}
\begin{center}
\includegraphics[angle=0,width=14cm]{./figures/cache_size_npb.png}
\label{fig:base_bram}
\end{center}
\end{frame}
\begin{frame}[label={sec:org1a20b07}]{Performance Dynamics}
\begin{center}
\includegraphics[angle=0,width=15cm]{./figures/associativity_unixbench.png}
\label{fig:base_bram}
\end{center}
\end{frame}
\begin{frame}[label={sec:org62f9c3c}]{Performance Dynamics}
\begin{center}
\includegraphics[angle=0,width=15cm]{./figures/btb_size_unixbench.png}
\label{fig:base_bram}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgcca1759}]{Performance Dynamics}
\begin{center}
\includegraphics[angle=0,width=15cm]{./figures/bht_size_unixbench.png}
\label{fig:base_bram}
\end{center}
\end{frame}
\begin{frame}[label={sec:org7c08a04}]{Resource Usage Dynamics}
\begin{center}
\includegraphics[angle=0,width=14cm]{./figures/sweep_btb_BRAM.png}
\label{fig:base_bram}
\end{center}
\end{frame}
\begin{frame}[label={sec:orge912a9a}]{Resource Usage Dynamics}
\begin{center}
\includegraphics[angle=0,width=14cm]{./figures/sweep_assoc_LUT.png}
\label{fig:base_bram}
\end{center}
\end{frame}
\begin{frame}[label={sec:org3c5d7c1}]{Resource Usage Dynamics}
\begin{center}
\includegraphics[angle=0,width=14cm]{./figures/sweep_assoc_BRAM.png}
\label{fig:base_bram}
\end{center}
\end{frame}
\begin{frame}[label={sec:org9f3204b}]{Resource Usage Dynamics}
\begin{center}
\includegraphics[angle=0,width=9cm]{./figures/sweep_cache_BRAM_3d.png}
\label{fig:base_bram}
\end{center}
\end{frame}
\section{Contributions}
\label{sec:org80e4666}
\begin{frame}[label={sec:org66ae698}]{Contributions}
\begin{itemize}
...
\label{sec:org9a36fa2}
\begin{frame}[label={sec:orga336423}]{Conclusion}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org5c24258}]{Future Work}
\begin{center}
\includegraphics[trim=0 0 0 0, clip,width=\textwidth]{roadmap_future.pdf}
\label{fig:roadmap}
\end{center}
\end{frame}
\begin{frame}[label={sec:org3711894}]{}
\frametitle{}
