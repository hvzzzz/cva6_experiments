...
\section{Motivation}
\label{sec:orgbdbd472}
\begin{frame}[label={sec:org89b5ead}]{The CVA6 Core}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2f4d82b}]{The CVA6 Core}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgfbc2216}]{The CVA6 Core}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org47af6ea}]{Problem Statement}
\begin{alertblock}{Problem}
\small The dual-core system is limited by a 1-request-per-cycle bandwidth at the L1D cache.
\end{alertblock}
\begin{exampleblock}{Research Objectives}\label{sec:org742d9b1}
\begin{itemize}
...
\end{exampleblock}
\end{frame}
\begin{frame}[label={sec:org762e29c}]{Project Roadmap}
\begin{center}
...
\label{sec:orgdb56f5b}
\begin{frame}[label={sec:org99a0461}]{How do We Measure Performance?}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org537a22b}]{How do We Measure Performance and Resource Usage?}
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org245742f}]{How do We Measure Resource Usage?}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org6c68d0f}]{How do We Measure Resource Usage?}
\begin{center}
\includegraphics[trim=0 0 230 0, clip,width=\textwidth]{./figures/cva6_stages_annotated.pdf}
\label{fig:stages}
\end{center}
\end{frame}
\begin{frame}[label={sec:org841dfda}]{How do We Measure Resource Usage?}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org111fa20}]{How do We Measure Resource Usage?}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org9658bc3}]{How do We Measure Resource Usage?}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgd1284ef}]{How do We Measure Resource Usage?}
...
\end{frame}
\section{Experiments}
\label{sec:org8c73f79}
\begin{frame}[label={sec:orgf4ab206}]{Baseline Architecture}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org8ecc132}]{Parameter Sweeps}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org46126f6}]{Automated Benchmarking Framework}
...
\label{sec:org8835fbf}
\begin{frame}[label={sec:org09b4825}]{Contributions}
\begin{itemize}
...
\label{sec:org99ab874}
\begin{frame}[label={sec:org2a71365}]{Conclusion}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org734ec27}]{Future Work}
\begin{center}
\includegraphics[trim=0 0 0 0, clip,width=\textwidth]{roadmap_future.pdf}
\label{fig:roadmap}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgf9fb669}]{}
\frametitle{}
